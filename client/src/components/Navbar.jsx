    ...
    <div className='flex items-center justify-between py-4'>
        ...
        
        {
            ...
            <div className='flex items-center gap-2 sm:gap-3'>
                <button onClick={()=> navigate("/buy")}     className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 hover:scale-105 transition-all duration-700 rounded-full'>
                    ...
                    <div className='relative group'>
                         <img className="w-10 drop-shadow" src={assets.profile_icon}></img>

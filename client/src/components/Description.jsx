  ...
  return (
    <motion.div initial={{opacity:0.2, y: 100}} transition= {{duration:1}} whileInView= {{opacity:1, y:0}} viewport = {{once:true}} className='flex flex-col items-center justify-center my-24 p-6 md:px-28'>
        ...
        <div className='flex flex-col gap-5  md:gap-14 md:flex-row'>
          ...
          <p className='text-gray-600 mb-4'>Easily bring ideas to life with our free AI image generator. Whether you need stunning visuals or unique imaginary, our tools transforms your text into eye-catching images with just few clicks. Imagine it, describes it, and watch it come to life instantly.</p>
